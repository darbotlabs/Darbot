import { CopilotChat } from "@darbotlm/react-core/v2";
 ...
 * throws when asked for an agent the runtime never synced. darbot exists to be forked, so a Bot
  ...
  return (
    <div className="flex h-screen flex-col">
      ...
      <div className="min-h-0 flex-1">
         ...
         * `threadId` is a controlled prop (node_modules/@darbotlm/react-core/dist/darbotlm-
