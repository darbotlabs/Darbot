...
function RouteComponent() {
  ...
  return (
    <PageShell
      description="How darbot looks and behaves for you. These apply to your account alone, on every deployment you sign in to."
      title="Preferences"
    >
        ...
        <PageRows>
          <Item size="sm">
            <ItemContent>
              ...
              <ItemDescription>
                Use the dark appearance across darbot.
              </ItemDescription>
            </ItemContent>
            <ItemActions>
              <Switch
