...
/**
 * The darbotlm client, wrapped once for the whole authenticated app.
 *
 * `credentials: "include"` is the load-bearing part. darbot authenticates with a Better Auth
...
export function CopilotProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <DarbotProvider
       ...
       * already turned on; it replaces the SDK's shadcn-flavoured house style with darbot's.
       */
