 ...
 *
 * A password is where this bites. `postgres://darbot:100%pure@host:5432/darbot` is a string
 ...
 *
 * `new SQL("postgres://user:pass@host:5432/darbot")` works on macOS and Linux and cannot work on
 * Windows: Bun reads the URL's path, `/darbot`, as the path of a unix socket, ignores the host and
