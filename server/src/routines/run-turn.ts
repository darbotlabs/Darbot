 ...
 *
 * WRITTEN AGAINST `@darbotlm/runtime` 1.69.0, MIRRORING
 * `node_modules/@darbotlm/runtime/dist/v2/runtime/core/channel-manager.mjs:189-316`
 ...
 * `@darbotlm/runtime/v2`, so the shapes in `IntelligenceLike` below are RESTATED BY HAND. Nothing
 ...
 * gateway, and it is the honest documentation of how much of `darbotlmIntelligence` a headless turn
