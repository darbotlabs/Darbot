 ...
 *
 * Memory is a cache of a shared record, not a per-process copy of it. darbot runs several servers
 ...
 *
 * Out of the box, darbot lets a Bot act, records every action and gives an administrator somewhere
