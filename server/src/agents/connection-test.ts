...
function probeBody() {
  return {
    threadId: `darbot-connection-test-${crypto.randomUUID()}`,
    runId: `darbot-connection-test-${crypto.randomUUID()}`,
    messages: [
      {
        id: crypto.randomUUID(),
        role: "user",
        content:
          "This is an automated connection test from darbot. Reply with one short word.",
      },
    ],
    tools: [],
    context: [],
