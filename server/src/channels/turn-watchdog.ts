 ...
 *
 * darbot runs in Intelligence mode and has no other mode, so `POST /api/darbotlm/agent/:id/run`
 ...
 * closes, the browser executes the tool, and the darbotlm client opens a SECOND run carrying the
 * result. Verified in @darbotlm/core 1.67.1, whose `processAgentResult` executes frontend tools
