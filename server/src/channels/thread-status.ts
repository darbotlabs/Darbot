 ...
 * person and either resolves or throws — rather than as the concrete `darbotlmIntelligence`
 ...
 * against the client's own error class, because that class is not part of `@darbotlm/runtime/v2`'s
