...
--
--   * the session sets `darbot.audit_retention_days` to a positive whole number, and
...
BEGIN
  ...
  BEGIN
    retention_days := nullif(current_setting('darbot.audit_retention_days', true), '')::integer;
