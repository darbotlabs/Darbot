...
It does not cover where the data comes from — that is `darbot-data-access`, which owns queries,
...
- The question is which states the screen renders while loading or failing → not this skill;
  `darbot-data-access`, Procedure 3.
