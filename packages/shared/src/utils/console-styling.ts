...
export const styledConsole = {
  ...
  success: (message: string) =>
    logStyled(`%cOK: ${message}`, [ConsoleStyles.section]),

  /** Log an info message */
  info: (message: string) => logStyled(`%cℹ ${message}`, [ConsoleStyles.info]),

  /** Log a feature highlight */
  feature: (message: string) =>
    logStyled(`%cNOTE: ${message}`, [ConsoleStyles.highlight]),

  /** Log a call-to-action */
  cta: (message: string) =>
    logStyled(`%cNEXT: ${message}`, [ConsoleStyles.cta]),
