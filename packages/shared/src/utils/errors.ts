...
const getVersionMismatchErrorMessage = ({
  ...
  `Version mismatch detected: @darbotlm/runtime@${runtimeVersion ?? ""} is not compatible with @darbotlm/react-core@${reactCoreVersion} and @darbotlm/runtime-client-gql@${runtimeClientGqlVersion}. Please ensure all installed copilotkit packages are on the same version.`;
/**
