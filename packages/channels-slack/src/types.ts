import type { ProviderActor } from "@darbotlm/channels-core";
import type { MessageOperation } from "@darbotlm/channels-ui";
...
/**
 * A upvote/downvote click on a streamed AI reply's native feedback row (Slack's
...
export interface SlackFeedbackOptions {
  /** Invoked when a user clicks upvote/downvote on a streamed reply. */
