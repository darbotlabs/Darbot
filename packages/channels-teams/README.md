# @darbotlm/channels-teams

The **Microsoft Teams platform adapter** for [`@darbotlm/channels`](../channels). It's a
concrete `PlatformAdapter` that plugs Teams into the platform-agnostic bot
engine, exactly like [`@darbotlm/channels-slack`](../channels-slack) does for Slack. You
...
```sh
pnpm add @darbotlm/channels @darbotlm/channels-ui @darbotlm/channels-teams
```
...
import { teams } from "@darbotlm/channels-teams";
