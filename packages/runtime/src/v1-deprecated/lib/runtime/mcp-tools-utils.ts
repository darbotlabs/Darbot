 ...
 *
 * @darbotlm/runtime — convertMCPToolsToActions:
 ...
 *
 * @darbotlm/runtime — extractParametersFromSchema:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Model Context Protocol): https://docs.copilotkit.ai/agentic-protocols/mcp
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — generateMcpToolInstructions:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Model Context Protocol): https://docs.copilotkit.ai/agentic-protocols/mcp
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 ...
 *
 * @darbotlm/runtime — MCPEndpointConfig:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Model Context Protocol): https://docs.copilotkit.ai/agentic-protocols/mcp
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
...
import type { Action, Parameter } from "@darbotlm/shared";
