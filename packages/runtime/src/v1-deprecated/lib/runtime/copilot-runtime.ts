 ...
 *
 * @darbotlm/runtime — copilotKitEndpoint:
 ...
 *
 * @darbotlm/runtime — CopilotRuntime:
 *   V2 import and usage:
 ...
 *
 * @darbotlm/runtime — CopilotRuntimeConstructorParams_BASE:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Runtime server adapter): https://docs.copilotkit.ai/runtime-server-adapter
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — langGraphPlatformEndpoint:
 *   No 1:1 v2 replacement is available.
 ...
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — resolveEndpointType:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Runtime server adapter): https://docs.copilotkit.ai/runtime-server-adapter
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 ...
 *
 * ```tsx
 * import { CopilotRuntime } from "@darbotlm/runtime";
 *
...
> {
   ...
   * (e.g., `@darbotlm/runtime`, `ai`) to establish a connection.
 ...
 * @deprecated The v1 SDK is deprecated. Use v2 instead. Use `CopilotRuntime` from `@darbotlm/runtime/v2` instead.
 *
 * ```tsx
 * import { CopilotRuntime } from "@darbotlm/runtime/v2";
 *
    ...
    if (
      ...
      throw new CopilotKitMisuseError({
        message:
          ...
          'Please use the "agents" option instead with LangGraphAgent from "@darbotlm/runtime/langgraph". ' +
