 ...
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — CopilotEndpointCorsConfig:
 *   V2 import and usage:
 ...
 *
 * @darbotlm/runtime — CopilotRequestContextProperties:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Runtime server adapter): https://docs.copilotkit.ai/runtime-server-adapter
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — CreateCopilotRuntimeServerOptions:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Runtime server adapter): https://docs.copilotkit.ai/runtime-server-adapter
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — getCommonConfig:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Runtime server adapter): https://docs.copilotkit.ai/runtime-server-adapter
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/runtime — GraphQLContext:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Runtime server adapter): https://docs.copilotkit.ai/runtime-server-adapter
 *   Start at: @darbotlm/runtime/v2
 *   V2 docs: https://docs.copilotkit.ai/
...
export function buildSchema(options: { emitSchemaFile?: string } = {}) {
