/**
 * Headless (platform-agnostic) exports from @darbotlm/react-core/v2.
 *
 ...
 * `@darbotlm/react-core/v2` entry re-exports from — importing any symbol from
...
// / useRenderActivityMessage (link @darbotlm/a2ui-renderer), which stay in the
// main /v2 entry.
...
// because @darbotlm/react-native derives its public render-prop types from it
