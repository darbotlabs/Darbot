...
import { DEFAULT_AGENT_ID } from "@darbotlm/shared";
...
import type { SubscribeToAgentSubscriber } from "@darbotlm/core";
...
interface UseAgentPropsBase {
   ...
   * window expires. See `CopilotKitCore.subscribeToAgentWithOptions` in `@darbotlm/core`
   * for details.
   *
