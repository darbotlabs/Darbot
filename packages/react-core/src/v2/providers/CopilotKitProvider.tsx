...
import type { FrontendTool } from "@darbotlm/core";
...
import { createLicenseContextValue } from "@darbotlm/shared";
import type {
  LicenseContextValue,
  DebugConfig,
...
import type { CopilotKitCoreErrorCode } from "@darbotlm/core";
import {
...
import { viewerTheme, filterCatalog, Catalog } from "@darbotlm/a2ui-renderer";
import type { Theme as A2UITheme } from "@darbotlm/a2ui-renderer";
...
import { schemaToJsonSchema, shouldEnableInspector } from "@darbotlm/shared";
import { zodToJsonSchema } from "zod-to-json-schema";

// Adapts zod-to-json-schema's zod-specific signature to the injectable
// `zodToJsonSchema` contract of `schemaToJsonSchema`. Zod v4 uses native
// conversion there; this fallback receives Zod v3 schemas.
...
export interface CopilotKitProviderProps {
  ...
  a2ui?: {
     ...
     * When omitted, the built-in `viewerTheme` from `@darbotlm/a2ui-renderer` is used.
     */
    theme?: A2UITheme;
    /**
