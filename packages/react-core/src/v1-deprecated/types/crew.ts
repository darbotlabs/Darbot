 ...
 *
 * @darbotlm/react-core — CrewsAgentState:
 *   No 1:1 v2 replacement is available.
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — CrewsResponse:
 *   No 1:1 v2 replacement is available.
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — CrewsResponseStatus:
 *   No 1:1 v2 replacement is available.
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — CrewsStateItem:
 *   No 1:1 v2 replacement is available.
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — CrewsTaskStateItem:
 *   No 1:1 v2 replacement is available.
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — CrewsToolStateItem:
 *   No 1:1 v2 replacement is available.
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
