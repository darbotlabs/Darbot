 ...
 *
 * @darbotlm/react-core — LangGraphInterruptAction:
 ...
 *
 * @darbotlm/react-core — LangGraphInterruptActionSetter:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Human-in-the-loop): https://docs.copilotkit.ai/human-in-the-loop
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — LangGraphInterruptActionSetterArgs:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Human-in-the-loop): https://docs.copilotkit.ai/human-in-the-loop
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — LangGraphInterruptRender:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Human-in-the-loop): https://docs.copilotkit.ai/human-in-the-loop
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — LangGraphInterruptRenderHandlerProps:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Human-in-the-loop): https://docs.copilotkit.ai/human-in-the-loop
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — LangGraphInterruptRenderProps:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Human-in-the-loop): https://docs.copilotkit.ai/human-in-the-loop
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — QueuedInterruptEvent:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Human-in-the-loop): https://docs.copilotkit.ai/human-in-the-loop
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
...
import type { LangGraphInterruptEvent } from "@darbotlm/runtime-client-gql";
