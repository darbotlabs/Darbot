 ...
 *
 * @darbotlm/react-core — CopilotKit:
 *   V2 import and usage:
 ...
 *
 * @darbotlm/react-core — defaultCopilotContextCategories:
 ...
 *
 * ```tsx
 * import { CopilotKit } from "@darbotlm/react-core";
 *
...
import type { Agent, ExtensionsInput } from "@darbotlm/runtime-client-gql";
import type {
      ...
      >
        <ThreadsProvider threadId={props.threadId}>
          {/*
            ...
            `@darbotlm/react-core/v2`, so it is the provider most integrations
