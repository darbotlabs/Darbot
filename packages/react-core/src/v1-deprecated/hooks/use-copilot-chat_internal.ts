 ...
 *
 * @darbotlm/react-core — ChatSuggestions:
 ...
 *
 * @darbotlm/react-core — OnReloadMessages:
 *   No 1:1 v2 replacement is available.
 ...
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — OnStopGeneration:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — useCopilotChatInternal:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — UseCopilotChatOptions:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — UseCopilotChatOptions_c:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — UseCopilotChatReturn_c:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
...
import { Message } from "@darbotlm/shared";
import {
  gqlToAGUI,
