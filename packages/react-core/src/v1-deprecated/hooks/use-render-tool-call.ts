 ...
 *
 * @darbotlm/react-core — useRenderToolCall:
 *   V2 import and usage:
...
import { getZodParameters } from "@darbotlm/shared";
import type { Parameter } from "@darbotlm/shared";
import { parseJson } from "@darbotlm/shared";
...
/**
 * @deprecated The v1 SDK is deprecated. Use v2 instead. Use `useRenderTool` from `@darbotlm/react-core/v2` instead.
 *
 * ```tsx
 * import { useRenderTool } from "@darbotlm/react-core/v2";
 * import { z } from "zod";
