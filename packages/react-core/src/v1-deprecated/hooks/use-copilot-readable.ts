 ...
 *
 * @darbotlm/react-core — useCopilotReadable:
 *   V2 import and usage:
 ...
 *
 * ```tsx
 * import { useCopilotReadable } from "@darbotlm/react-core";
 *
 ...
 * @deprecated The v1 SDK is deprecated. Use v2 instead. Use `useAgentContext` from `@darbotlm/react-core/v2` instead.
 *
 * ```tsx
 * import { useAgentContext } from "@darbotlm/react-core/v2";
 *
