 ...
 *
 * @darbotlm/react-core — useCopilotRuntimeClient:
...
import type { CopilotErrorHandler, CopilotErrorEvent } from "@darbotlm/shared";
import {
  ErrorVisibility,
...
export interface CopilotRuntimeClientHookOptions
  extends CopilotRuntimeClientOptions {
