 ...
 *
 * @darbotlm/react-core — useLangGraphInterrupt:
 *   V2 import and usage:
...
import { MetaEventName } from "@darbotlm/runtime-client-gql";
...
/**
 * @deprecated The v1 SDK is deprecated. Use v2 instead. Use `useInterrupt` from `@darbotlm/react-core/v2` instead.
 *
 * ```tsx
 * import { useInterrupt } from "@darbotlm/react-core/v2";
 *
