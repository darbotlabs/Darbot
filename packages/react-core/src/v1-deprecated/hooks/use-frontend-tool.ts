 ...
 *
 * @darbotlm/react-core — useFrontendTool:
 *   V2 import and usage:
...
import { ToolCallStatus } from "@darbotlm/core";
import {
...
/**
 * @deprecated The v1 SDK is deprecated. Use v2 instead. Use `useFrontendTool` from `@darbotlm/react-core/v2` instead.
 *
 * ```tsx
 * import { useFrontendTool } from "@darbotlm/react-core/v2";
 * import { z } from "zod";
