 ...
 *
 * @darbotlm/react-core — ThreadsContext:
 ...
 *
 * @darbotlm/react-core — ThreadsContextValue:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Conversation threads): https://docs.copilotkit.ai/prebuilt-components/copilot-threads-drawer
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — ThreadsProvider:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Conversation threads): https://docs.copilotkit.ai/prebuilt-components/copilot-threads-drawer
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — ThreadsProviderProps:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Conversation threads): https://docs.copilotkit.ai/prebuilt-components/copilot-threads-drawer
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — useThreads:
 *   V2 import and usage:
...
import { randomUUID } from "@darbotlm/shared";
