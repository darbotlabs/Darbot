 ...
 *
 * @darbotlm/react-core — CopilotMessagesContext:
 ...
 *
 * @darbotlm/react-core — CopilotMessagesContextParams:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — useCopilotMessagesContext:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (Chat UI): https://docs.copilotkit.ai/prebuilt-components/chat
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
...
import type { Message } from "@darbotlm/runtime-client-gql";
import React from "react";
import type { Suggestion } from "@darbotlm/core";
