 ...
 *
 * @darbotlm/react-core — CoAgentStateRendersContext:
 ...
 *
 * @darbotlm/react-core — CoAgentStateRendersContextValue:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (State rendering): https://docs.copilotkit.ai/generative-ui/state-rendering
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — CoAgentStateRendersProvider:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (State rendering): https://docs.copilotkit.ai/generative-ui/state-rendering
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
 *   V2 reference docs: https://docs.copilotkit.ai/reference/v2
 *
 * @darbotlm/react-core — useCoAgentStateRenders:
 *   No 1:1 v2 replacement is available.
 *   Related v2 docs (State rendering): https://docs.copilotkit.ai/generative-ui/state-rendering
 *   Start at: @darbotlm/react-core/v2
 *   V2 docs: https://docs.copilotkit.ai/
