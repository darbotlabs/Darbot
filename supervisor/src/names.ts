 ...
 *
 * Container and volume names are global to a Docker host, so two darbot deployments sharing a host
 ...
 */
export const DEFAULT_NAMESPACE = "darbot";
