 ...
 *
 * Every write is scoped by ownership. Containers are created carrying `darbot.supervisor`, and
 ...
 * computer, upgrading darbot never reached it. Rebuilding the image moves the tag; the container
