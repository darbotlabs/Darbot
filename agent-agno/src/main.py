...
def _model_id() -> str:
    """`provider/model`, which is how litellm addresses one and how darbot stores the choice."""
...
agent = Agent(
    # In memory, because a Bot's history lives in darbot's database and not in the harness. Two
    ...
    # asked, and anybody who wants a persona sets one in darbot where the rest of them live.
